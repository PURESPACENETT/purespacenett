...
const description =
  "Mentions légales de PURE SPACE NETT, entreprise individuelle de nettoyage au Pré-Saint-Gervais.";
        ...
        <div className="mt-8 max-w-3xl space-y-8 text-sm leading-relaxed">
          <section>
            ...
            <dl className="mt-3 space-y-2">
              ...
              <div>
                <dt className="font-semibold">Exploitant</dt>
              ...
              <div>
                <dt className="font-semibold">SIRET du siège</dt>
                <dd>{business.siret}</dd>
              </div>
              <div>
                <dt className="font-semibold">TVA intracommunautaire</dt>
          ...
          <section>
            ...
            <p className="mt-3">
              Activité principale : nettoyage courant des bâtiments (APE 81.21Z). Le site présente
              les prestations de nettoyage proposées aux particuliers et aux professionnels.
            </p>
          </section>
